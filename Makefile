...
debug:    CFLAGS += -O0 -g3
debug:    $(EXE_DIR)/$(PROJECTNAME) top.exe

release:  $(EXE_DIR)/$(PROJECTNAME) top.exe
...
install :
	install -m 0755 exe/bg-ncp-bond.exe ~/bin/bg-ncp-bond-helper.exe
	install -m 0755 top.exe ~/bin/bg-ncp-bond.exe
...
ble-ncp-cli :
	git clone https://github.com/joe-possum/ble-ncp-cli.git
